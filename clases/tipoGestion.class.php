...
function agregarTipoGestion($nombre_tipo_gestion){ 
    $var_nombre_tipo        =   $nombre_tipo_gestion;
    
    include("/var/www/html/crm/conexiones/mysql.inc.php");
    $insertar="INSERT INTO tipo_gestion(nombre_tipo_gestion)
    VALUES('$var_nombre_tipo') ";
